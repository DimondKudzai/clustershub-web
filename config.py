...
class Config:
    SQLALCHEMY_DATABASE_URI = 'postgresql://neondb_owner:npg_M8IRz5fpyPSs@ep-silent-mud-ahoblu0u-pooler.c-3.us-east-1.aws.neon.tech/neondb?sslmode=require&channel_binding=require'
